...
class CmReplyNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject("یک پاسخ جدید برای دیدگاهتان ثبت گردید")
            ->line("یک پاسخ جدید در پست زیر برایتان ارسال شد")
