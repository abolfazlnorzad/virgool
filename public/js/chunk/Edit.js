(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/chunk/Edit"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    ...
    var changePost = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["debounce"])(function () {
      savePostUpdate().then(function () {
        snackbar.saved = true;
      })["catch"](function () {
        snackbar.error = true;
      });
    ...
    var savePostUpdate = function savePostUpdate() {
    ...
    var savePost = function savePost() {
      changePost.cancel();
      savePostUpdate().then(function (_ref4) {
        var data = _ref4.data;
        var slug = data.slug ? data.slug : "/posts/".concat(root.$route.params.slug);
        root.$router.push("".concat(slug, "/update"));
      });
    };

    var showPostSave = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__["computed"])(function () {
      return title.value && content.value;
    });
    return {
      savePost: savePost,
      showPostSave: showPostSave,
      title: title,
      content: content,
      snackbar: snackbar,
