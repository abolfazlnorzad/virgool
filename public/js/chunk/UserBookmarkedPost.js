(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/chunk/UserBookmarkedPost"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    ...
    axios.get("/api/bookmarked-posts").then(function (_ref3) {
      var data = _ref3.data;
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    [
                      _c("div", [_c("p", [_vm._v("نوشته های ذخیره شده من")])]),
                      _vm._v(" "),
                      _c("v-spacer"),
                      _vm._v(" "),
                      _c("div", [
                        _c("p", [
                          _vm._v(
                            "تعداد نوشته های مربوطه: " +
                              _vm._s(_vm.user.bookmarks_count)
                          )
                        ]),
                        _vm._v(" "),
                        _c("p")
                  ...
                  _c(
                    ...
                    [
                      ...
                      !_vm.posts.data.length
                        ? _c("span", [
                            _vm._v("شما هیچ نوشته ذخیره شده ای ندارید!")
                          ])
                        : _vm._e(),
                      _vm._v(" "),
