(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/chunk/ResetEmailPassword"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    ...
    var sended = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_2__["ref"])(false);

    function sendEmail() {
      if (refs.resetPassword.validate()) {
        loading.value = true;
        root.$store.dispatch('user/sendEmail', form.value).then(function () {
