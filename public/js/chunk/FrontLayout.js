(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/chunk/FrontLayout"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    read: function read(notif) {
      var _this = this;

      axios.patch("/api/notifications/".concat(notif.id)).then(function () {
        _this.$router.push(notif.data.link);
      });
    }
  },
  created: function created() {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_3__["mapState"])('user', ['user']))
});
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c(
                            "router-link",
                            {
                              staticClass: "mt-10 mr-4 hidden-sm-and-down",
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "v-list",
        _vm._l(_vm.$store.state.notification.notifications, function(item) {
          return _c(
            "v-list-item",
            { key: item.id },
            [
...
var render = function() {
  ...
  return _c(
    "div",
    [
      (_vm.user && _vm.user.isVerified == 1
      ? true
      : false)
        ? _c("verify-banner")
        : _vm._e(),
