(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/chunk/AdminLayout"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    showLink: function showLink(roles) {
      var _this = this;
      ...
      _c(
        ...
        [
          ...
          _vm._l(_vm.items, function(item) {
            return _vm.showLink(item.roles)
              ? _c(
                  "v-list-item",
                  { key: item.text, attrs: { to: { name: item.to } } },
                  [
